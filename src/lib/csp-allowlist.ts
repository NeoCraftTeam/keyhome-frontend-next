...
export const CSP_FRAME_HOSTS_STATIC =
  'https://*.clerk.accounts.dev https://*.clerk.com https://challenges.cloudflare.com https://checkout.flutterwave.com https://pay.genius.ci https://js.stripe.com https://hooks.stripe.com https://vercel.live https://accounts.google.com https://www.googletagmanager.com https://*.googletagmanager.com https://*.keyhome.app https://*.keyhome.cm https://*.keyhome.neocraft.dev https://*.neocraft.dev';
