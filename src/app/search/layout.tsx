...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description:
      "Carte interactive + filtres par ville, budget et type de bien. Trouvez votre logement parmi des milliers d'annonces vérifiées en Afrique.",
    ...
    itemListElement: [
      {
        ...
        url: 'https://keyhome.app/search?city=douala&type=Appartement',
      },
      {
        '@type': 'ListItem',
        position: 2,
        name: 'Maisons à Douala',
        url: 'https://keyhome.app/search?city=douala&type=Maison',
      },
      {
        '@type': 'ListItem',
        position: 3,
        name: 'Appartements à Yaoundé',
        url: 'https://keyhome.app/search?city=yaounde&type=Appartement',
      },
      {
        '@type': 'ListItem',
        position: 4,
        name: 'Maisons à Yaoundé',
        url: 'https://keyhome.app/search?city=yaounde&type=Maison',
      },
      {
        '@type': 'ListItem',
        position: 5,
        name: 'Appartements à Abidjan',
        url: 'https://keyhome.app/search?city=abidjan&type=Appartement',
      },
      {
        '@type': 'ListItem',
        position: 6,
        name: 'Villas à Abidjan',
        url: 'https://keyhome.app/search?city=abidjan&type=Villa',
      },
      {
        '@type': 'ListItem',
        position: 7,
        name: 'Terrains à Dakar',
        url: 'https://keyhome.app/search?city=dakar&type=Terrain',
      },
      {
        '@type': 'ListItem',
        position: 8,
        name: 'Bureaux à Abidjan',
        url: 'https://keyhome.app/search?city=abidjan&type=Bureau',
      },
      {
        '@type': 'ListItem',
        position: 9,
        name: 'Studios à Cotonou',
        url: 'https://keyhome.app/search?city=cotonou&type=Studio',
      },
      {
        '@type': 'ListItem',
        position: 10,
        name: 'Villas à Dakar',
        url: 'https://keyhome.app/search?city=dakar&type=Villa',
      },
    ],
  };
