    ...
    <div style={{ maxWidth: 900, margin: '0 auto', padding: '48px 20px 80px' }}>
      ...
      <section style={{ marginTop: 56, padding: 28, background: '#f9f9f9', borderRadius: 16 }}>
        ...
        <div style={{ display: 'flex', flexWrap: 'wrap', gap: 10, fontSize: 14 }}>
          <Link href="/search" style={{ color: brand.primary, textDecoration: 'none' }}>🔍 Rechercher un logement</Link>
          <span style={{ color: '#ddd' }}>·</span>
          <Link href="/immobilier/douala" style={{ color: brand.primary, textDecoration: 'none' }}>Immobilier Douala</Link>
          <span style={{ color: '#ddd' }}>·</span>
          <Link href="/immobilier/abidjan" style={{ color: brand.primary, textDecoration: 'none' }}>Immobilier Abidjan</Link>
          <span style={{ color: '#ddd' }}>·</span>
          <Link href="/immobilier/cotonou" style={{ color: brand.primary, textDecoration: 'none' }}>Immobilier Cotonou</Link>
        </div>
      </section>
    </div>
  );
