...
export const COMPARISONS: Record<string, Comparison> = {
  'louer-vs-acheter': {
    ...
    metaTitle:
      'Louer vs Acheter un bien immobilier en Afrique — Comparatif 2026',
    metaDescription:
        ...
        items: [
          {
            ...
            a: "Caution (1-3 mois) + frais d'agence",
            b: 'Apport 20-30% + frais de notaire (5-8%)',
          },
          {
            label: 'Mensualité typique (Douala 3 pièces)',
            a: '80 000 – 200 000 FCFA/mois',
            b: 'Crédit immobilier : 100 000 – 350 000 FCFA/mois',
          },
          {
            label: 'Charges imprévues',
            a: 'Couvertes par le bailleur (gros travaux)',
            b: 'À votre charge entièrement',
          },
        ],
      },
      {
        ...
        items: [
          {
            ...
            a: 'Déménagement facile',
            b: 'Contraignant (vente ou mise en location)',
          },
          {
            label: 'Personnalisation du logement',
            a: 'Limité (accord bailleur requis)',
            b: 'Liberté totale de rénovation',
          },
          {
            label: "Sécurité d'occupation",
            a: 'Risque de non-renouvellement',
            b: 'Propriétaire = sécurité maximale',
          },
        ],
      },
      {
        ...
        items: [
          {
            ...
            a: 'L\'argent "disparaît" chaque mois',
            b: 'Capital constitué sur le long terme',
          },
          {
            label: 'Effet de levier',
            a: 'Aucun',
            b: 'Crédit bancaire amplifie le retour',
          },
          {
            label: 'Revenus locatifs possibles',
            a: 'Non',
            b: 'Sous-location possible',
          },
        ],
      },
      {
        ...
        items: [
          {
            ...
            a: 'N/A',
            b: 'Taux élevés (12-18%) — limité aux salariés du secteur formel',
          },
          {
            label: 'Sécurité juridique',
            a: 'Contrats souvent informels',
            b: 'Titre foncier complexe dans certains pays',
          },
          {
            label: 'Marché locatif (demande)',
            a: 'Fort dans les grandes villes',
            b: 'Bonne rentabilité locative brute (6-10%)',
          },
        ],
      },
    ],
  ...
  'douala-vs-yaounde': {
    ...
    metaTitle:
      'Immobilier Douala vs Yaoundé — Prix, quartiers, rentabilité 2026',
    metaDescription:
    ...
    sections: [
      {
        ...
        items: [
          {
            label: 'Loyer moyen 3 pièces',
            a: '120 000 – 250 000 FCFA/mois',
            b: '80 000 – 180 000 FCFA/mois',
          },
          {
            label: 'Prix achat appartement (m²)',
            a: '200 000 – 450 000 FCFA/m²',
            b: '150 000 – 350 000 FCFA/m²',
          },
      ...
      },
      {
        ...
        items: [
          {
            label: 'Standing supérieur',
            a: 'Bonapriso, Bonanjo, Akwa',
            b: 'Bastos, Omnisport, Fébé',
          },
          {
            label: 'Cadres / expatriés',
            a: 'Bonamoussadi, Makepe, Deido',
            b: 'Tsinga, Santa Barbara, Mvog-Ada',
          },
          {
            label: 'Budget moyen',
            a: 'Ndokotti, Logbessou, Kotto',
            b: 'Nkolbisson, Simbock, Mimboman',
          },
        ],
      },
      {
        ...
        items: [
          {
            label: 'Profil de la ville',
            a: 'Capital économique, port, industrie',
            b: 'Capitale administrative, fonctionnaires, ONG',
          },
          {
          ...
          },
          {
            ...
            a: 'Très forte (expatriés, salariés privés)',
            b: 'Stable (fonctionnaires, étudiants)',
          },
        ],
      },
      {
        ...
        items: [
          {
            ...
            a: 'Très importants',
            b: "Importants mais moins qu'à Douala",
          },
          {
            label: 'Sécurité',
            a: 'Variable selon le quartier',
            b: 'Globalement bonne',
          },
          {
            label: 'Infrastructures',
            a: 'Port, aéroport international',
            b: 'Aéroport, routes bien entretenues',
          },
        ],
      },
    ],
  ...
  'appartement-vs-maison': {
    ...
    metaTitle:
      "Appartement ou Maison en Afrique de l'Ouest ? Comparatif complet 2026",
    metaDescription:
    ...
    sections: [
      {
        ...
        items: [
          {
            label: 'Surface moyenne disponible',
            a: '45 – 120 m²',
            b: '80 – 300 m²',
          },
          {
            label: 'Espace extérieur',
            a: 'Balcon uniquement (si disponible)',
            b: 'Jardin, terrasse, cour',
          },
      ...
      },
      {
        ...
        items: [
          {
            label: 'Prix location (3 pièces Douala)',
            a: '120 000 – 200 000 FCFA',
            b: '150 000 – 400 000 FCFA',
          },
          {
            label: 'Charges mensuelles',
            a: 'Syndic, gardiennage, eau communes',
            b: 'Eau, électricité, entretien jardin',
          },
          {
            label: 'Charges imprévues',
            a: 'Partielles (mutualisées)',
            b: 'Entièrement à votre charge',
          },
        ],
      },
      {
        ...
        items: [
          {
            ...
            a: 'Gardien, interphone, résidence fermée',
            b: 'Dépend du quartier et de la clôture',
          },
          {
            label: 'Intimité',
            a: 'Voisins directs, bruit',
            b: "Plus d'indépendance",
          },
          {
            label: 'Nuisances sonores',
            a: "Variable selon l'immeuble",
            b: 'Moins de bruit en général',
          },
        ],
      },
    ],
