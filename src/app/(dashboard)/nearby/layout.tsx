...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: "Explorez les logements disponibles autour de vous sur une carte interactive. Géolocalisation en temps réel, filtres par budget et type de bien.",
