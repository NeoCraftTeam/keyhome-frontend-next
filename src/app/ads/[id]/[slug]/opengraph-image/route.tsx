...
export async function GET(
  ...
  try {
    const res = await fetch(`${API_URL}/ads/${id}`, { next: { revalidate: 60 } });
  ...
  const location = [ad.quarter?.name, ad.quarter?.city_name].filter(Boolean).join(', ');
      ...
      >
        ...
        >
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 8 }}>
            ...
            <span style={{ color: 'white', fontWeight: 600, fontSize: 18 }}>KeyHome</span>
          </div>

          {/* Title */}
          <div style={{ color: 'white', fontSize: 36, fontWeight: 800, lineHeight: 1.2, maxWidth: 700 }}>
          ...
          <div style={{ display: 'flex', gap: 24, marginTop: 8 }}>
            ...
            {ad.surface_area && (
              <div style={{ color: 'white', fontSize: 18, display: 'flex', alignItems: 'center', gap: 6 }}>
