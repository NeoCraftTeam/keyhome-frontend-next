...
export default function ProgressiveContactForm() {
  ...
  const isStepValid = (step: FormStep) => {
    switch (step) {
      ...
      case 'message':
        return formData.message.trim().length > 5;
      default:
        return false;
    }
  };
                  ...
                  <AnimatePresence mode="wait">
                    {currentStep === 'complete' ? (
                      ...
                      >
                        ...
                        <Badge
                          variant="secondary"
                          className="mt-8 px-6 py-2 rounded-xl bg-primary/5 text-primary border-none"
                        >
                          {t('formData.time')}
                        </Badge>
                      </motion.div>
                      ...
                      >
                        <div className="mb-12">
                          ...
                          <h3 className="text-3xl md:text-4xl font-bold tracking-tight">
                            ...
                            {currentStep === 'email' &&
                              `${t('formStepTitle.email.start')} ${formData.name}${t('formStepTitle.email.end')}`}
                            {currentStep === 'subject' &&
                              t('formStepTitle.subject')}
                            {currentStep === 'message' &&
                              t('formStepTitle.message')}
                          </h3>
                        </div>
                        ...
                        <div className="mt-12 flex justify-between items-center">
                          <div className="flex items-center gap-4">
                            {['email', 'subject', 'message'].includes(
                              currentStep
                            ) && (
                              <Button
                                variant="ghost"
