...
import {
  AccessibleForwardOutlined as AccessibleForward,
  AcUnitOutlined as AcUnit,
  BalconyOutlined as Balcony,
  CheckroomOutlined as Checkroom,
  DeckOutlined as Deck,
  ElevatorOutlined as Elevator,
  FitnessCenterOutlined as FitnessCenter,
  KitchenOutlined as Kitchen,
  LocalFireDepartmentOutlined as LocalFireDepartment,
  LocalLaundryServiceOutlined as LocalLaundryService,
  PetsOutlined as Pets,
  PoolOutlined as Pool,
  SecurityOutlined as Security,
  SmokeFreeOutlined as SmokeFree,
  TvOutlined as Tv,
  WarehouseOutlined as Warehouse,
  WhatshotOutlined as Whatshot,
  WifiOutlined as Wifi,
  YardOutlined as Yard,
