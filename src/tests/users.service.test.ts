...
describe('usersService', () => {
  ...
  describe('update', () => {
    ...
    it('appends _method=PUT and sends multipart FormData', async () => {
      ...
      expect(mockPost).toHaveBeenCalledWith('/users/user-abc-123', formData, {
...
describe('unlockedAdsService', () => {
  describe('list', () => {
    it('unwraps ads from data.data', async () => {
      ...
      expect(mockGet).toHaveBeenCalledWith('/my/unlocked-ads');
    ...
    it('propagates errors', async () => {
      mockGet.mockRejectedValue(new AxiosError('Unauthenticated'));
